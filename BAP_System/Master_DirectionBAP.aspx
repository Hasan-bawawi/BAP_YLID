...
<%@ Page  Title="Master Direction"  MasterPageFile="~/Layout.Master"  Language ="C#" AutoEventWireup="true" CodeBehind="Master_DirectionBAP.aspx.cs" Inherits="BAP_System.Master_DirectionBAP" %>
...
<script src="Scripts/sweetalert.min.js"></script>
    <script type="text/javascript">
        ...
        function FuncSave() {
            swal({
                title: 'Save Success',
                text:  'Direction Successfully Submit',
                timer: '2000',
                type: 'success',
        ...
        function FuncUpdate() {
            swal({
                ...
                text: 'Direction Successfully Updated',
                timer: '2000',
                type: 'success',
                showConfirmButton: false,
                html: true,
  ...
  <script>
      ...
      function validateRow(btn) {
          ...
          var Direction = row.querySelector("#txtDirectionType");

          var isValid = true;


          [Direction].forEach(function (input) {
              if (input) input.style.border = "";
          });

       

          if (!Direction || Direction.value.trim() === "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow" style="color: white;">Direction</h1>
        </div>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class='col-sm-12'>
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">List of Direction</legend>
                                    <div class="row">
                                      <div class='col-sm-12'>
                                        ...
                                        <div class='col-sm-12'>
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="TableDirection" ClientIDMode="Static" runat="server" AutoGenerateColumns="False"
                                                CssClass="table table-striped table-bordered zero-configuration grid"
                                                EmptyDataText="No Record Found"
                                                Style="width: 100%"
                                                ShowHeaderWhenEmpty="true"
                                                OnRowEditing="TableDirection_RowEditing"
                                                OnRowCancelingEdit="TableDirection_RowCancelingEdit"
                                                OnRowUpdating="TableDirection_RowUpdating"
                                                OnRowDataBound="TableDirection_RowDataBound"
                                                DataKeyNames="Direction_id">
...
<%--                                                            <asp:BoundField DataField="CreatedDate" HeaderText="Create Date" ReadOnly="True" DataFormatString="{0:dd-MMMM-yyyy hh:mm:ss tt}"/>--%>
 ...
 <!--**********************************
	Modal New User
***********************************-->
  <div class="modal fade bs-example-modal-lg" id="mdlAddDirection" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">

              <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel1">Add Direction</h4>
              ...
              <div class="modal-body">
                  <div class="x_content">
            <div class="row">
                          <asp:HiddenField ID="Direction_id" runat="server" />
                         <%--<asp:HiddenField ID="hlbOid" runat="server" />--%>
            <div class='col-sm-12'>
                    Direction Type
			<div class="form-group" style="margin-top:5px;">
                      <div class='input-group'>
                          <input runat="server" id="txtDirectionTypeadd" name="DirectionType" data-validate-length-range="5,15" type="text" class="form-control input-rounded required-field" placeholder="Type Branch Name" >
                      </div>
                </div>
           </div>
            </div>
